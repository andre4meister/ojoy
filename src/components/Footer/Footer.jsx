    ...
    <div className={styles.about}>
      ...
      <div className={styles.about__info}>
        <div className={styles.info__politics}>
          <p>
            © 2023 ojoy.com, всі матеріали взяті з відкритих джерел мережі інтернет для ознайомлювальних цілей та
        ...
        <div className={styles.about__menu}>
          ...
          <div className={styles.menu_items}>
            <p className={styles.menu_item}>ojoy@gmail.com</p>
            <p className={styles.menu_item}>+380777000777</p>
          </div>
        </div>
        <div className={styles.about__collaboration}>
          <div className={styles.about__block_title}>Співпраця</div>
          <div className={styles.menu_items}>
            <p className={styles.menu_item}>ojoycoop@gmail.com</p>
            <p className={styles.menu_item}>+380333000333</p>
          </div>
        </div>
